...
;          :foreground "white" :background "green" :weight bold :inherit mode-line)
          :foreground "#005f8a" :background "#87d7ff" :weight bold :inherit mode-line)
         (t (:weight bold)))
...
;          :foreground "white" :background "red" :weight bold :inherit mode-line)
          :foreground "#005f00" :background "#afd700" :weight bold :inherit mode-line)
         (t (:weight bold)))
...
;          :foreground "white" :background "orange" :weight bold :inherit mode-line)
          :foreground "#875f00" :background "#ffaf00" :weight bold :inherit mode-line)
         (t (:weight bold)))
...
;          :foreground "white" :background "black" :weight bold :inherit mode-line)
          :foreground "white" :background "#d70000" :weight bold :inherit mode-line)
         (t (:weight bold)))
